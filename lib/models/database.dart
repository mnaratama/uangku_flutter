...
import 'package:uangku_flutter/models/category.dart';
import 'package:uangku_flutter/models/transaction.dart';
...
class AppDb extends _$AppDb {
  ...
  Future deleteCategoryRepo(int id) async {
    return (delete(categories)..where((tbl) => tbl.type.equals(id))).go();
  }
